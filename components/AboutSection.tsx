    ...
    <section id="about" className="w-full py-28">
      <div className="max-w-[1280px] mx-auto px-4 md:px-16 flex flex-col md:flex-row gap-12 items-center">
        <div className="reveal w-full md:w-1/2">
          <div className="relative aspect-video md:aspect-square rounded overflow-hidden">
            <Image
              fill
              src="/images/photo-3.jpg"
              alt="LA Roofing team installing a roof"
              className="object-cover"
              sizes="(max-width: 768px) 100vw, 50vw"
            />
          </div>
        </div>
        <div className="reveal w-full md:w-1/2 flex flex-col gap-6">
