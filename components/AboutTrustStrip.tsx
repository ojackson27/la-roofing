const cards = [
  {
    title: "Fully Insured",
    body: "Complete protection for your property and full peace of mind on every job.",
    icon: (
  ...
  },
  {
    ...
    body: "Years of hands-on experience delivering roofing that's built to last.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" width="24" height="24">
  ...
  {
    title: "Local to Exeter & Devon",
    body: "A local team who knows the area, the building codes, and the weather.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" width="24" height="24">
