...
export default function Footer() {
  return (
    <footer className="bg-[var(--color-primary)] text-white py-20 mt-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <p className="text-white/70 text-sm mt-3 leading-relaxed">
              LA Roofing — Los Angeles&apos; trusted roofing specialists. Quality work, guaranteed results.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex items-start gap-2">
                ...
                <span className="text-white/70 text-sm">(213) 555-0147</span>
              </div>
              ...
              <div className="flex items-start gap-2">
                ...
                <span className="text-white/70 text-sm">info@laroofing.com</span>
              </div>
